  ...
  return (
    <main className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-gray-900 to-black px-4 sm:px-6">
      ...
      <div className="text-center w-full max-w-2xl mx-auto space-y-6 sm:space-y-8 py-12">
        ...
        >
          <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl tracking-tight bg-clip-text bg-gradient-to-r from-blue-400 via-emerald-400 to-cyan-400 text-transparent font-bold">
            Zeus
          </h1>
          <h2 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl tracking-tight bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-emerald-500 text-transparent font-bold">
            Lightning
          </h2>
        </MotionDiv>
        ...
        >
          <Button
            size="lg"
            className="rounded-full px-6 sm:px-8 py-5 text-sm sm:text-base bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 transition-all cursor-pointer shadow-lg shadow-blue-500/20"
          ...
          <Button
            variant="secondary"
            size="lg"
            className="rounded-full px-6 sm:px-8 py-5 text-sm sm:text-base border-white/20 bg-white/5 hover:bg-white/10 backdrop-blur-lg transition-all cursor-pointer"
