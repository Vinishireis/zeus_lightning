              ...
              {uploadComplete ? (
                ...
                >
                  ...
                  <div className="flex justify-center gap-4">
                    ...
                    <Link href="/Dashboard">
                      <button className="px-6 py-2 font-medium rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-lg hover:shadow-blue-500/20 transition-all duration-200 cursor-pointer">
                        Ver relatórios
                      </button>
                    </Link>
                  </div>
